...
public:
	CKeyboardState OldKeyState;
	CKeyboardState NewKeyState;
	CKeyboardState TempKeyState;
...
public:
	...
	void UpdateKeyboard(int* key, bool arr) {
	...
	void StartShake(short dur, char freq) {
		ApiCALL::CallMethod(__FUNCTION__, this, dur, freq);
	}
	void StopShaking() {
		ApiCALL::CallMethod(__FUNCTION__, this);
	}
